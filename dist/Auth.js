                      ...
                      switch ((_context.prev = _context.next)) {
                        ...
                        case 2:
                          (username = fields.username),
                            ...
                            (verifiedPassword = fields.verifiedPassword);
                        ...
                        case 5:
                          if (
                            !(password.trim().length < _this.passwordLength)
                          ) {
                            _context.next = 7;
                            break;
                          }
                            ...
                            function (error, info) {
                              if (error) {
                                return response.status(500).json({
                                  msg: "Network Error: Failed to send confirmation email. ".concat(
